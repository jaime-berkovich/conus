...
diffusion_rates = {
    'A': 0.0001,   # nearly zero → local Hopf dominates
    'B': 0.001    # same speed → no long-range inhibition
}
...
# ─────────────────────────────────────────────────────
output_path = os.path.join(output_folder, "spatiotemporal_concentrations_hopf_turing.png")
